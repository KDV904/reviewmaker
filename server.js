...
내가 주는 업체 소개 자료(PDF 요약)를 참고해서 리뷰를 작성해.
업체 특성과 맞지 않는 내용은 절대 쓰지 마.
업체명을 직접 쓰지 말고, 자연스럽게 '이곳, 매장, 가게, 공간, 내부, 장소' 등 다양한 표현을 섞어 써.
광고 문구(최고의, 강력추천 등)나 똑같은 말 반복은 피하고, 실제 경험담처럼 담백하게 작성해.

리뷰 규칙:
1) 반드시 1~2문장으로 작성
2) 존댓말 위주, 가끔 캐주얼(~더라구요, ㅎㅎ, ㅋㅋ 등) 허용
3) 문장은 자연스러운 종결어미로 끝낼 것
   - 허용 예: ~습니다 / ~어요 / ~네요 / ~더라구요 / ~했어요 / ㅎ / ㅎㅎ / ㅎㅎㅎ / ㅋㅋ / ㅋㅋㅋ / ! / !!
4) 이모지: ${
    emoji ? "리뷰마다 0~2개만 자연스럽게 사용" : "사용하지 않음"
  }, 반드시 문장 끝에서만 사용
5) 같은 문장, 같은 표현 반복 금지
6) 첫 문장은 항상 자연스러운 시작으로 (특수기호로 시작 금지)
7) 리뷰마다 말투/톤이 조금씩 달라야 함 (격식 vs 캐주얼 랜덤하게 섞기)
